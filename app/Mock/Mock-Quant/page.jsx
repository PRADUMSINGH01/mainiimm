...
const mathTopics = [
  { name: 'Algebra', icon: <TbMathOff  />, link: 'algebra', description: 'Master averages to solve tricky problems with ease.' },
  { name: 'Averages', icon: <FaCalculator />, link: 'Averages', description: 'Master averages to solve tricky problems with ease.' },
  { name: 'Percentages', icon: <FaPercent />, link: 'percentages', description: 'Understand percentages to tackle real-world calculations.' },
  { name: 'Profit & Loss', icon: <FaMoneyBillWave />, link: 'Profit-loss', description: 'Learn the key formulas to ace profit and loss questions.' },
  { name: 'Ratio & Proportion', icon: <FaBalanceScale />, link: 'Ratios-and-Proportion', description: 'Get a solid grasp of ratios and proportions for quantitative problems.' },
  { name: 'Simple & Compound Interest', icon: <FaMoneyBillWave />, link: 'Interest', description: 'Calculate interest efficiently with powerful techniques.' },
  { name: 'Time & Work', icon: <FaClock />, link: 'Time-work', description: 'Learn time and work problems step-by-step to improve speed.' },
  { name: 'Time, Speed & Distance', icon: <FaTachometerAlt />, link: 'Time-Speed-Distance', description: 'Solve motion-related problems by mastering speed and distance.' },
  { name: 'Number System', icon: <FaSortNumericUp />, link: 'Number-System', description: 'Strengthen your basics in number theory for complex questions.' },
  { name: 'Algebra', icon: <FaSuperscript />, link: 'Algebra', description: 'Conquer algebraic equations and enhance your problem-solving.' },
