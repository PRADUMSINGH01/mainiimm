...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Inequalities/Levelthree'} LEVELINFO={'Inequalities Level-Three'} LEVELONE={"Level-One"} LEVELTWO={"Level-Two"} LevelTwoURL={"/Inequalities/Level_two"} LevelOneURL={"/Inequalities/"}/>
    </div>
  )
}
