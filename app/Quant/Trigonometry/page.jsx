...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Trigonometry/Questions'} LEVELINFO={'Trigonometry Level-One'} LEVELONE={"Level-two"} LEVELTWO={"Level-three"} LevelTwoURL={"/Trigonometry/Level-three"} LevelOneURL={"/Trigonometry/Level-two"}/>
    </div>
  )
}
