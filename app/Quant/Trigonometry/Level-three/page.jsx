...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Trigonometry/Levelthree'} LEVELINFO={'Trigonometry Level-Three'} LEVELONE={"Level-One"} LEVELTWO={"Level-Two"} LevelTwoURL={"/Trigonometry/Level-two"} LevelOneURL={"/Trigonometry/"}/>
    </div>
  )
}
