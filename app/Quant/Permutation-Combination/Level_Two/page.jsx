...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Permutation-Combination/Questions'} LEVELINFO={'Permutation-Combination Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-three"} LevelTwoURL={"/Permutation-Combination/Level_Three"} LevelOneURL={"/Permutation-Combination/"}/>
    </div>
  )
}
