...
const page = () => {
  ...
  return (
    <div>
      <LevelQuestions
        FETCHURL={"/Quant/Permutation-Combination/Levelthree"}
        LEVELINFO={"Permutation-Combination Level-Three"}
        LEVELONE={"Level-One"}
        LEVELTWO={"Level-Two"}
        LevelTwoURL={"/Permutation-Combination/Level_Two"}
        LevelOneURL={"/Permutation-Combination/"}
      />
    </div>
  );
};
