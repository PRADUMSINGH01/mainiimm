...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Permutation-Combination/Questions'} LEVELINFO={'Permutation-Combination Level-One'} LEVELONE={"Level-two"} LEVELTWO={"Level-three"} LevelTwoURL={"/Permutation-Combination/Level_Three"} LevelOneURL={"/Permutation-Combination/Level_Two"}/>
    </div>
  )
}
