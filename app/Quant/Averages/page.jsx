...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Averages/Questions'}  LEVELINFO={" Averages Level One"} LEVELONE={"Level-Two"} LEVELTWO={"Level-Three"} LevelTwoURL={"/Averages/Level-Three"} LevelOneURL={"/Averages/Level-Two"}/>
    </div>
  )
}
