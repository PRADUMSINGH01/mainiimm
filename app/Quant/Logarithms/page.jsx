...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Logarithms/Questions'} LEVELINFO={'Logarithms Level-One'} LEVELONE={"Level-Two"} LEVELTWO={"Level-Three"} LevelTwoURL={"/Logarithms/Level-three"} LevelOneURL={"/Logarithms/Level-two"}/>
    </div>
  )
}
