...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Logarithms/Leveltwo'} LEVELINFO={'Logarithms Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-Three"} LevelTwoURL={"/Logarithms/Level-three"} LevelOneURL={"/Logarithms/"}/>
    </div>
  )
}
