...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Logarithms/Levelthree'} LEVELINFO={'Logarithms Level-Three'} LEVELONE={"Level-One"} LEVELTWO={"Level-Two"} LevelTwoURL={"/Logarithms/Level-two"} LevelOneURL={"/Logarithms/"}/>
    </div>
  )
}
