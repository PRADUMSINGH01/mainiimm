...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Ratios-and-Proportion/Level-two'} LEVELINFO={'Ratios-and-Proportion Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-three"} LevelTwoURL={"/Ratios-and-Proportion/Level-three"} LevelOneURL={"/Ratios-and-Proportion/"}/>
    </div>
  )
}
