...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Ratios-and-Proportion/Questions'} LEVELINFO={'Ratios-and-Proportion Level-One'} LEVELONE={"Level-two"} LEVELTWO={"Level-three"} LevelTwoURL={"/Ratios-and-Proportion/Level-three"} LevelOneURL={"/Ratios-and-Proportion/Level-two"}/>
    </div>
  )
}
