...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Time-Speed-Distance/Levelthree'} LEVELINFO={'Time-Speed-Distance Level-Three'} LEVELONE={"Level-One"} LEVELTWO={"Level-Two"} LevelTwoURL={"/Time-Speed-Distance/Level-two"} LevelOneURL={"/Time-Speed-Distance/"}/>
    </div>
  )
}
