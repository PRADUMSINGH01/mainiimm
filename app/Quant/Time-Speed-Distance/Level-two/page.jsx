...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Time-Speed-Distance/Leveletwo'} LEVELINFO={'Time-Speed-Distance Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-three"} LevelTwoURL={"/Time-Speed-Distance/Level-three"} LevelOneURL={"/Time-Speed-Distance/Level-two"}/>
    </div>
  )
}
