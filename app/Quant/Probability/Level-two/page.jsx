...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Probability/Leveltwo'} LEVELINFO={'Probability Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-Three"} LevelTwoURL={"/Probability/Level-three"} LevelOneURL={"/Probability/"}/>
    </div>
  )
}
