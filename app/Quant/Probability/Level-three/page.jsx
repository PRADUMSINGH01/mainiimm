...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Probability/Levelthree'} LEVELINFO={'Probability Level-Three'} LEVELONE={"Level-One"} LEVELTWO={"Level-Two"} LevelTwoURL={"/Probability/Level-two"} LevelOneURL={"/Probability/"}/>
    </div>
  )
}
