...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Probability/Questions'} LEVELINFO={'Probability Level-One'} LEVELONE={"Level-two"} LEVELTWO={"Level-three"} LevelTwoURL={"/Probability/Level-three"} LevelOneURL={"/Probability/Level-two"}/>
    </div>
  )
}
