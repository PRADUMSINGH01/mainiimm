...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Work-and-Time/Levelthree'} LEVELINFO={'Work-and-Time Level-Three'} LEVELONE={"Level-One"} LEVELTWO={"Level-Two"} LevelTwoURL={"/Time-work/Level-two"} LevelOneURL={"/Time-work/"}/>
    </div>
  )
}
