...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Work-and-Time/Leveltwo'} LEVELINFO={'Work-and-Time Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-three"} LevelTwoURL={"/Time-work/Level-three"} LevelOneURL={"/Time-work/"}/>
    </div>
  )
}
