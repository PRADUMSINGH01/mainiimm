...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Number-System/Leveltwo'} LEVELINFO={'Number-System Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-three"} LevelTwoURL={"/Number-System/Level-three"} LevelOneURL={"/Number-System/"}/>
    </div>
  )
}
