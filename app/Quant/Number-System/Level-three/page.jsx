...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Number-System/Levelthree'} LEVELINFO={'Number-System Level-Three'} LEVELONE={"Level-One"} LEVELTWO={"Level-Two"} LevelTwoURL={"/Number-System/Level-two"} LevelOneURL={"/Number-System/"}/>
    </div>
  )
}
