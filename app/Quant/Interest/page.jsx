...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Compound-interest/Questions'} LEVELINFO={'Interest Level-One'} LEVELONE={"Level-Two"} LEVELTWO={"Level-Three"} LevelTwoURL={"/Interest/Level_three"} LevelOneURL={"/Interest/Level_two"}/>
    </div>
  )
}
