...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Quadratic-equations/Level-two'} LEVELINFO={'Quadratic-equations Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-three"} LevelTwoURL={"/Quadratic-equations/Level-three"} LevelOneURL={"/Quadratic-equations/"}/>
    </div>
  )
}
