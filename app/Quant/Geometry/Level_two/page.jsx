...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Geometry/LevelTwo'} LEVELINFO={'Geometry Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-Three"} LevelTwoURL={"/Geometry/Level_three"} LevelOneURL={"/Geometry/"}/>
    </div>
  )
}
