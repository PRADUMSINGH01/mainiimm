...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Profit-&-Loss/Questions'} LEVELINFO={'Profit-loss Level-One'} LEVELONE={"Level-two"} LEVELTWO={"Level-three"} LevelTwoURL={"/Profit-loss/Level-three"} LevelOneURL={"/Profit-loss/Level-two"}/>
    </div>
  )
}
