...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/Mensuration/Questions'} LEVELINFO={'Mensuration Level-One'} LEVELONE={"Level-two"} LEVELTWO={"Level-three"} LevelTwoURL={"/Mensuration/Level-three"} LevelOneURL={"/Mensuration/Level-two"}/>
    </div>
  )
}
