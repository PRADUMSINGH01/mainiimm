...
const page = () => {
  ...
  return (
    <div>
  <LevelQuestions FETCHURL={'/Quant/Mensuration/Leveltwo'} LEVELINFO={'Mensuration Level-Two'} LEVELONE={"Level-One"} LEVELTWO={"Level-three"} LevelTwoURL={"/Mensuration/Level-three"} LevelOneURL={"/Mensuration/"}/>
    </div>
  )
}
