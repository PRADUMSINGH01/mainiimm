...
const page = () => {
  ...
  return (
    <div>
        <LevelQuestions FETCHURL={'/Quant/percentages/LevelThree'} LEVELINFO={'Percentages Level-Three'} LEVELONE={"Level-One"} LEVELTWO={"Level-Two"} LevelTwoURL={"/Percentages/Level-two"} LevelOneURL={"/Percentages/"}/>
    </div>
  )
}
